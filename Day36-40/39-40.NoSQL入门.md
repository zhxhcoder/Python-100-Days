...
3. 文档的CRUD操作。
   ...
   ```JavaScript
   > // 向students集合插入文档
   > db.students.insert({stuid: 1001, name: '团子', age: 38})
   WriteResult({ "nInserted" : 1 })
   > // 向students集合插入文档
   > db.students.save({stuid: 1002, name: '嘟子', tel: '13012345678', gender: '男'})
   WriteResult({ "nInserted" : 1 })
   > // 查看所有文档
   > db.students.find()
   { "_id" : ObjectId("5b13c72e006ad854460ee70b"), "stuid" : 1001, "name" : "团子", "age" : 38 }
   { "_id" : ObjectId("5b13c790006ad854460ee70c"), "stuid" : 1002, "name" : "嘟子", "tel" : "13012345678", "gender" : "男" }
   > // 更新stuid为1001的文档
   ...
   { "name" : "嘟子", "tel" : "13012345678" }
   { "name" : "白元芳", "tel" : "13022223333" }
   > // 查询name为“团子”或者tel为“13022223333”的文档
   > db.students.find({'$or': [{name: '团子'}, {tel: '13022223333'}]}, {_id: 0, name: 1, tel: 1}).pretty()
   { "name" : "团子", "tel" : "13566778899" }
   { "name" : "白元芳", "tel" : "13022223333" }
   > // 查询学生文档跳过第1条文档只查1条文档
...
'name_1'
>>> coll.insert_one({'stuid': int(1001), 'name': '团子', 'gender': True})
<pymongo.results.InsertOneResult object at 0x1050cc6c8>
>>> coll.insert_many([{'stuid': int(1002), 'name': '嘟子', 'gender': False}, {'stuid': int(1003), 'name': '白元芳', 'gender': True}])
